...
class BuildPromptRequest(_message.Message):
    __slots__ = ("req_id", "client_id", "prompt_id", "source_id", "from_time", "to_time")
    ...
    from_time: str
    to_time: str
    def __init__(self, req_id: _Optional[str] = ..., client_id: _Optional[str] = ..., prompt_id: _Optional[int] = ..., source_id: _Optional[str] = ..., from_time: _Optional[str] = ..., to_time: _Optional[str] = ...) -> None: ...
