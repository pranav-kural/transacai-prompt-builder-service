...
def build_prompt(req_id: str, client_id: str, prompt_id: int, source_id: RecordsDBType, from_time: str, to_time: str) -> str:
    """
    ...
    source_id (RecordsDBType): ID of database to use for records
    ...
    # get records
    primaryRecordsDB = get_primary_records_db(db_type=source_id)
